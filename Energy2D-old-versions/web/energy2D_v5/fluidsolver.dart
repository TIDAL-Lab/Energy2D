 ...
 */
 class FluidSolver2D {
  ...
  int relaxationSteps = 2;

  double viscosity = 10 * 0.00001568; // 10 * Constants.AIR_VISCOSITY;
  double thermalBuoyancy = 0.00025; // 0.00025;
  double gravity = 0.0;
  int buoyancyApproximation = Model2D.BUOYANCY_AVERAGE_ALL;
  int gravityType = Model2D.GRAVITY_UNIFORM;
  double timeStep =  0.1; //0.1;
  ...
  void diffuse(int b, Matrix<double> f0, Matrix<double> f) {
    ...
    double h = timeStep * 0.02 * nx1 * ny1;
